...
choice = gets.chomp.to_i
  ...
  case choice
      ...
      when 8
          ...
          i = 1
          while i <= num_max
            number = journalists.count {|a| a.length == i}
            puts "il y a #{number} de handle avec #{i} caractère(s)"
            i += 1
          end 
      else
        puts "entre 1 & 8 please"
  end